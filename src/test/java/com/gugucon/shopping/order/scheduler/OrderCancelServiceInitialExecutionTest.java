...
class OrderCancelServiceInitialExecutionTest {
    ...
    @Test
    @DisplayName("30분 이상 전에 마지막으로 변경된 주문을 취소한다.")
    void cancelIncompleteOrders_cancelOrderLastModifiedMoreThan30MinutesAgo() {
        // given
