...
class OrderTest {
    ...
    void addOrderItem() {
        ...
        final OrderItem 치킨 = new OrderItem(1L, order, "치킨", new Money(10000), "chicken.png",
            new Quantity(3));
        final OrderItem 피자 = new OrderItem(2L, order, "피자", new Money(20000), "pizza.png",
            new Quantity(4));
        ...
        assertThat(order.getTotalPrice()).isEqualTo(new Money(110000));
    }
